...
create-app:
	...
	$(COMPOSE_EXEC) $(WEB) $(MANAGE_PY) startapp $$app_name apps/$$app_name && \
	$(COMPOSE_EXEC) $(WEB) sed -i "s/name = '$$app_name'/name = 'apps.$$app_name'/" apps/$$app_name/apps.py && \
	echo "Created app 'apps.$$app_name'"
